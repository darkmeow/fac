...
QMAKE    = /usr/bin/qmake
menuFAC.xcodeproj/project.pbxproj: menuFAC.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o menuFAC.xcodeproj/project.pbxproj menuFAC.pro
